...
Blockly.Msg["CONTROLS_FLOW_STATEMENTS_WARNING"] = "这个积木只能在循环内使用哦~";
...
Blockly.Msg["CONTROLS_IF_IF_TOOLTIP"] = "增加、删除或重新排列各节来重新配置这个if语句积木";
...
Blockly.Msg["CONTROLS_REPEAT_INPUT_DO"] = "那么";
...
Blockly.Msg["DELETE_ALL_BLOCKS"] = "真的要删除所有 %1 个积木吗？";
...
Blockly.Msg["IOS_VARIABLES_EMPTY_NAME_ERROR"] = "你还不能使用空白的变量名哦~";
...
Blockly.Msg["LISTS_CREATE_WITH_CONTAINER_TOOLTIP"] = "增加、删除或重新排列各部分以此重新配置这个列表积木";
...
Blockly.Msg["LOGIC_BOOLEAN_FALSE"] = "不成立";
Blockly.Msg["LOGIC_BOOLEAN_HELPURL"] = "https://github.com/google/blockly/wiki/Logic#values";  // untranslated
Blockly.Msg["LOGIC_BOOLEAN_TOOLTIP"] = "返回成立或不成立;
Blockly.Msg["LOGIC_BOOLEAN_TRUE"] = "成立";
Blockly.Msg["LOGIC_COMPARE_HELPURL"] = "https://zh.wikipedia.org/wiki/不等";
Blockly.Msg["LOGIC_COMPARE_TOOLTIP_EQ"] = "如果两个输入结果相等，则返回成立";
Blockly.Msg["LOGIC_COMPARE_TOOLTIP_GT"] = "如果第一个输入结果比第二个大，则返回成立";
Blockly.Msg["LOGIC_COMPARE_TOOLTIP_GTE"] = "如果第一个输入结果大于或等于第二个输入结果，则返回成立";
Blockly.Msg["LOGIC_COMPARE_TOOLTIP_LT"] = "如果第一个输入结果比第二个小，则返回成立";
Blockly.Msg["LOGIC_COMPARE_TOOLTIP_LTE"] = "如果第一个输入结果小于或等于第二个输入结果，则返回成立";
Blockly.Msg["LOGIC_COMPARE_TOOLTIP_NEQ"] = "如果两个输入结果不相等，则返回成立";
...
Blockly.Msg["LOGIC_NULL_TOOLTIP"] = "返回空值（null）";
Blockly.Msg["LOGIC_OPERATION_AND"] = "并且";
Blockly.Msg["LOGIC_OPERATION_HELPURL"] = "https://github.com/google/blockly/wiki/Logic#logical-operations";  // untranslated
Blockly.Msg["LOGIC_OPERATION_OR"] = "或者";
Blockly.Msg["LOGIC_OPERATION_TOOLTIP_AND"] = "如果两个输入结果都为真，则返回成立";
Blockly.Msg["LOGIC_OPERATION_TOOLTIP_OR"] = "如果至少有一个输入结果为真，则返回成立";
Blockly.Msg["LOGIC_TERNARY_CONDITION"] = "判断条件";
Blockly.Msg["LOGIC_TERNARY_HELPURL"] = "https://zh.wikipedia.org/wiki/条件运算符";
Blockly.Msg["LOGIC_TERNARY_IF_FALSE"] = "如果成立";
Blockly.Msg["LOGIC_TERNARY_IF_TRUE"] = "如果不成立";
Blockly.Msg["LOGIC_TERNARY_TOOLTIP"] = "检查“条件”里的条件语句。如果条件为真，则返回“如果成立”的值，否则，则返回“如果不成立”的值";
...
Blockly.Msg["MATH_CONSTANT_TOOLTIP"] = "返回一个常见常量：π (3.1415926…)、e (2.718…)、φ (1.618…)、平方根 (1.414…)、开平方根 (0.707…)或∞ (无限大Infinity)";
...
Blockly.Msg["MATH_IS_TOOLTIP"] = "检查一个数值是否是偶数、奇数、质数、自然数、正数、负数或者是否能被某数整除。返回成立或不成立。";
...
Blockly.Msg["VARIABLE_ALREADY_EXISTS"] = "名字叫“%1”的变量已经存在了，换一个名字吧~";
